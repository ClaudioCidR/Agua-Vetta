...
interface ProductosMaintainerProps {
  onProductoCreado?: () => void;
}

export default function ProductosMaintainer({ onProductoCreado }: ProductosMaintainerProps) {
  ...
  const handleSubmit = async (e: FormEvent<HTMLFormElement>) => {
    ...
    if (exito) {
      ...
      // Si es un nuevo producto, llamar al callback para actualizar la lista en ventas
      if (esNuevo && onProductoCreado) {
        onProductoCreado();
      }
    }
  };
