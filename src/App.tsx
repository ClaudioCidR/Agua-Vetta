...
export default function App() {
  ...
  const sugerenciasFiltradas = busquedaCliente.trim().length > 0
    ...
    : clientes.slice(0, 8);
  const [tipoDoc, setTipoDoc] = useState<'BOLETA' | 'FACTURA' | 'FACT.PENDIENTE'>('BOLETA');
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="bg-white p-6 rounded-xl shadow-md lg:col-span-2 flex flex-col justify-between">
          <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-3 mb-4 bg-gray-50 p-4 rounded-xl border">
              ...
              <div className="flex items-end">
                <button
                  ...
                  className="w-full bg-green-600 hover:bg-green-700 disabled:bg-gray-300 text-white font-bold py-2 rounded-lg shadow transition"
                >
                  + Agregar Item
                </button>
              </div>
